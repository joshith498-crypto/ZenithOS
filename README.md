...
* **CSS3** (Custom CRT animations, Grid/Flexbox layouts, and custom UI window styling)
* **Vanilla JavaScript** (Dynamic window state management, Canvas-rendered gaming engine, and command-line parsing)

...
function setupTerminalConsole() {
    ...
    input.addEventListener('keydown', (e) => {
        ...
        switch (cmd) {
            case 'help':
                printLine('Commands: help, ls, pwd, cd, mkdir, touch, rm, mv, cp, cat, clear, date, whoami, zenith, echo, reboot, shutdown');
                break;
            case 'pwd':
            ...
            case 'whoami':
                ...
                break;
            case 'zenith': printLine('   _____            _ _   _ ');
